...
NUM_BINS = [20, 20]  # This needs to be changed
...
if __name__ == '__main__':
    ...
    if train:
        ...
        Q = np.zeros(
            [399, env.action_space.n])  # The number 9999 needs to be changed every time you chan change NUM_BINS
    if test:
    ...
    alpha = 0.15  # This needs to be changed ( same as problem 1)
    gamma = 0.999  # This needs to be changed ( same as problem 1)
    ...
    if train:
        ...
        for episode in range(n_episodes):
            ...
            while done != True:
                ...
                Q[s, action] += alpha * (reward + gamma * predicted_value - Q[
                    s, action])  # This needs to be changed similar to problem 1
